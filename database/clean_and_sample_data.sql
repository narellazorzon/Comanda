-- Script para limpiar datos existentes e insertar datos de ejemplo
-- Ejecutar después de crear la base de datos

USE comanda;

-- Limpiar datos existentes (en orden inverso para evitar errores de FK)
DELETE FROM detalle_pedido;
DELETE FROM pedidos;
DELETE FROM propinas;
DELETE FROM pagos;
...
ALTER TABLE propinas AUTO_INCREMENT = 1;
ALTER TABLE pagos AUTO_INCREMENT = 1;
ALTER TABLE llamados_mesa AUTO_INCREMENT = 1;
