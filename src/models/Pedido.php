...
class Pedido {
    ...
    public static function create(array $data): int {
        ...
        try {
            ...
            // Manejo mejorado del id_mozo - prioridad a Develop pero con lógica mejorada de juaki-develop
            $idMozo = null;
            if (isset($data['id_mozo']) && $data['id_mozo']) {
                $idMozo = $data['id_mozo'];
            } elseif (isset($_SESSION['user']['id_usuario'])) {
                // Usar el usuario logueado si está disponible
    ...
    /**
     * Obtiene un pedido con su información completa incluyendo propina (método de juaki-develop)
     */
    ...
    /**
     * Calcula el total con propina (método agregado de juaki-develop)
     */
